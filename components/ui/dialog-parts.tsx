...
export function DialogContent({
  ...
  return (
    <DialogPrimitive.Portal data-slot="dialog-portal">
      <DialogOverlay />
      <DialogPrimitive.Popup data-slot="dialog-content" className={cn(contentClass, className)} {...props}>
        {children}
        {showCloseButton && (
...
export function DialogFooter({
  ...
  return (
    <div data-slot="dialog-footer" className={cn(footerClass, className)} {...props}>
      {children}
