...
export function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return <SheetPrimitive.Backdrop data-slot="sheet-overlay" className={cn(overlayClass, className)} {...props} />;
}
...
export function SheetContent({
  ...
  return (
    <SheetPrimitive.Portal data-slot="sheet-portal">
      <SheetOverlay />
      <SheetPrimitive.Popup data-slot="sheet-content" data-side={side} className={cn(contentClass, className)} {...props}>
        {children}
        {showCloseButton && (
